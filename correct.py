...
from prompts import correct_ocr
...
OCR_CONTEXT_INTRO = correct_ocr.OCR_CONTEXT_INTRO
PROMPT_JA = correct_ocr.PROMPT_JA
PROMPT_TH = correct_ocr.PROMPT_TH
PROMPT_MIXED = correct_ocr.PROMPT_MIXED
...
PROMPT_CONTEXT_BASE = correct_ocr.PROMPT_CONTEXT_BASE
PROMPT_CONTEXT_TH = correct_ocr.PROMPT_CONTEXT_TH
PROMPT_CONTEXT_JA = correct_ocr.PROMPT_CONTEXT_JA
